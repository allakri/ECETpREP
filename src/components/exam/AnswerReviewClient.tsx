...
const LoadingSkeleton = () => (
    <div className="flex h-screen w-full items-center justify-center bg-background">
        <div className="w-full max-w-6xl mx-auto p-4 md:p-6 grid grid-cols-1 md:grid-cols-4 gap-6 h-[calc(100vh-8rem)]">
...
export default function AnswerReviewClient() {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] bg-secondary/10 text-foreground">
        <div className="container mx-auto h-full flex flex-col md:flex-row gap-6 py-6">
            <aside className="w-full md:w-80 lg:w-96 bg-card border rounded-lg p-4 flex flex-col gap-4">
            ...
            <main className="flex-1 flex flex-col h-full overflow-y-auto">
                ...
                <CardFooter className="flex justify-end items-center gap-4 border-t pt-4 mt-auto">
