...
import { CheckCircle, XCircle, ChevronLeft, ChevronRight, Lightbulb, Home, AlertCircle, Loader2, MessageSquarePlus, Bot, User, Send, HelpCircle, BarChart, PanelRightOpen } from 'lucide-react';
